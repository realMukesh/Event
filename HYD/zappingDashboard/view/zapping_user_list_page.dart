            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12,),
                  _buildTitle(title: "Email:",subtitle: userData.email??""),
                  const SizedBox(height: 12,),
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: userData.isPrinted==0?Colors.green:Colors.red,
                        borderRadius: const BorderRadius.all(Radius.circular(25)),
                      ),
                      child: Row(
                        children: [
                          ImageIcon(AssetImage("assets/icons/print_icon.png"),color: userData.isPrinted==0?Colors.white:Colors.white,),
                          const SizedBox(width: 6,),
                          RegularTextView(text: userData.isPrinted==1?"Allotted":"Allot",color: userData.isPrinted==0?Colors.white:Colors.white,)
                        ],
                      ),
                    ),
                  ),
