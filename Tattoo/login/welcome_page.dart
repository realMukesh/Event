    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: Obx(() => SizedBox(
              ...
              child: isContinueClick.value ? _buildAgree() : _buildContinue(),
            )),
      ),
    );
  }
        ...
        Column(
          ...
          children: [
            ...
            Align(
                ...
                child: InkWell(
                    onTap: () {
                      isContinueClick(!isContinueClick.value);
                    },
                    child: Padding(
                      padding: const EdgeInsets.symmetric(vertical: 30),
                      child: Image.asset(
        ...
        const Padding(
          ...
          child: SingleChildScrollView(
            child: Text(
              ...
              style: TextStyle(
                color: white,
                fontSize: 16,fontFamily: "GOTHICB"
              ),
        ...
        Align(
            ...
            child: InkWell(
                ...
                child: const Padding(
                  ...
                  child: Text(
                    "WAIVER FORM",
                    style: const TextStyle(fontFamily: "Brewmaster",fontSize: 30,
