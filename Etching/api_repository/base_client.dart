  ...
  postData(
    ...
    /*if (!UiHelper.isNetworkAvailable()) {
      ...
      Get.showSnackbar(GetSnackBar(
        title: "Network",
        message: "You are not connected to internet please try again.",
      ));
      return _processResponse({"success":false,"message":"You are not connected to internet please try again","results": {}});
    }*/
